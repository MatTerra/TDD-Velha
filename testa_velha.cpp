...
TEST_CASE("Testa coluna 2 toda igual retorna vencedor",
          "[single-file]") {
    int teste1[3][3] = {
            {0, 1, 0},
            {2, 1, 0},
...
TEST_CASE("Se 1 ja jogou pelo menos 3 vezes e ngm ganhou retorna 0",
          "[single-file]") {
    int teste1[3][3] = {
            {1, 1, 0},
            {2, 2, 1},
...
TEST_CASE("Diagonal principal 2 deve retornar 2",
          "[single-file]") {
    int teste1[3][3] = {
            {2, 1, 1},
            {1, 2, 0},
...
TEST_CASE("Diagonal secundaria 1 deve retornar 1",
          "[single-file]") {
    int teste1[3][3] = {
            {0, 0, 1},
            {2, 1, 2},
